...
def draw_text(text): #when game ends this shows the restart text
    s = pygame.Surface((400, 50))
    s.fill((0, 0, 0))
    screen.blit(s, (100, 600))
    text_surface = font.render(text, False, (12, 54, 64))
    if 'DRAW' in text:
        x = 260
    else:
        x = 230
    text_surface_restart = font.render('PRESS "SPACE" TO RESTART', False, (12, 54, 64))
...
def get_depth(): # the first screen which gets the depth and shows it also
    ...
    while True:
        ...
        background_image = pygame.image.load("assets/depthbgimage.png")  # Replace "background_image.jpg" with your image file
